...
<script>
    ...
    function filter() {
        ...
        $("#printout").attr('src', '<?= base_url('warehouse/report_inventory_turnover_fg/print') ?>' + url);
    }
    ...
    function excel() {
        ...
        url = "?filter_from=" + filter_from + "&filter_to=" + filter_to + "&filter_items=" + filter_items + "&filter_display=" + filter_display + "&filter_trans_type=" + filter_trans_type;
        window.location.assign('<?= base_url('warehouse/report_inventory_turnover_fg/print/excel') ?>' + url);
    }
