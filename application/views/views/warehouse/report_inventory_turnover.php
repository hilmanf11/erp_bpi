...
<script>
    ...
    function filter() {
        ...
        $("#printout").attr('src', '<?= base_url('warehouse/report_inventory_turnover/print') ?>' + url);
    }
    ...
    function excel() {
        ...
        var filter_item_family = $("#filter_item_family").combobox('getValue');
        var filter_division = $("#filter_division").combobox('getValue');
        var url = "?filter_from=" + filter_from + "&filter_to=" + filter_to + "&filter_item_category=" + filter_item_category + "&filter_item_family=" + filter_item_family  + "&filter_division=" + filter_division;

        // Tampilkan overlay
        $("#loadingOverlay").show();

        // Unduh file
        window.location.assign('<?= base_url('warehouse/report_inventory_turnover/print/excel') ?>' + url);
        ...
        $("#filter_item_category").combobox({
            ...
            onSelect: function(category) {
                $("#filter_item_family").combobox({
                    url: '<?= base_url('warehouse/report_inventory_turnover/readItemFamily/') ?>' + category.id,
                    valueField: 'number',
                    textField: 'name',
    ...
    $("#filter_item_family").combobox({
        url: '<?= base_url('warehouse/report_inventory_turnover/readItemFamilys/') ?>',
        valueField: 'number',
        textField: 'name',
        prompt: "Select Product Family",
        icons: [{
