...
<script>
    function filter() {
        ...
        if (filter_from == "" || filter_to == "") {
            ...
            $("#printout").attr('src', '<?= base_url('warehouse/report_check_serialno_sto_fg/print') ?>' + url);
        }
    }
    function excel() {
        var filter_from = $("#filter_from").datebox("getValue");
        ...
        if (filter_from == "" || filter_to == "") {
            ...
            window.location.assign('<?= base_url('warehouse/report_check_serialno_sto_fg/print/excel') ?>' + url);
        }
    }
    function pdf() {
