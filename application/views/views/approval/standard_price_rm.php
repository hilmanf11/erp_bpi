...
<table id="dg" class="easyui-datagrid" style="width:99.5%;" toolbar="#toolbar">
    <thead>
        <tr>
            ...
            <th data-options="field:'document_number',width:150,align:'left'">Document No.</th>
            <th data-options="field:'start_date',width:120,halign:'center'">Start Date</th>
            <th data-options="field:'end_date',width:120,halign:'center'">Ending Date</th>
            <th data-options="field:'division_name',width:120,halign:'center'">Division</th>
            <th data-options="field:'item_rm_id',width:150,halign:'center'">Part ID</th>
            ...
            <th data-options="field:'uom',width:80,halign:'center',align:'right'">UoM</th>
            <th data-options="field:'division_name',width:100,align:'center'">Division</th>
            <th data-options="field:'item_category_name',width:100,align:'center'">Category</th>
            <th data-options="field:'item_family_name',width:100,align:'center'">Family</th>
            <th data-options="field:'currency',width:80,halign:'center',align:'center'">Currency</th>
            <th data-options="field:'price',width:150,halign:'center',align:'right',formatter:numberformatPrice">Price</th>
        </tr>
    </thead>
</table>
...
<script>
    ...
    $(function() {
        ...
        $('#dg').datagrid({
            url: '<?= base_url('approvals/approvalStandardPriceRm/') ?>' + "<?= base64_encode($approved_to) ?>" + "/" + "<?= base64_encode($approved_by) ?>",
            pagination: false,
            singleSelect: false,
            clientPaging: false,
            rownumbers: true,
