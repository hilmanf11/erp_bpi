        ...
        <fieldset style="width: 100%; border:2px solid #d0d0d0; margin-bottom: 5px; margin-top: 5px; border-radius:4px;">
            ...
            <div style="width: 35%; float: left;">
                <div class="fitem">
                    ...
                    <input style="width:30%;" id="filter_from" value="" data-options="formatter:myformatter,parser:myparser,editable:false" class="easyui-datebox">
                    <input style="width:30%;" id="filter_to" value="" data-options="formatter:myformatter,parser:myparser,editable:false" class="easyui-datebox">
                </div>
                <div class="fitem">
                    <span style="width:35%; display:inline-block;">Delivery Date</span>
                    <input style="width:30%;" id="filter_delivery_date_from" value="" data-options="formatter:myformatter,parser:myparser" class="easyui-datebox">
                    <input style="width:30%;" id="filter_delivery_date_to" value="" data-options="formatter:myformatter,parser:myparser" class="easyui-datebox">
                </div>
                <div class="fitem">
...
<script>
    ...
    function filter() {
        ...
        var filter_delivery_date_from = $("#filter_delivery_date_from").datebox("getValue");
        var filter_delivery_date_to = $("#filter_delivery_date_to").datebox("getValue");
        ...
        var url = "?filter_from=" + window.btoa(filter_from) +
            ...
            "&filter_delivery_date_from=" + window.btoa(filter_delivery_date_from) +
            "&filter_delivery_date_to=" + window.btoa(filter_delivery_date_to) +
        ...
        $('#dlg_insert').dialog({
            buttons: [{
                ...
                handler: function() {
                    ...
                    var currencies = rows.map(row => row.currency);
                    var uniqueCurrencies = [...new Set(currencies)];
                    if (uniqueCurrencies.length > 1) {
                        toastr.error("Create Failed!, There can only be One currency in SO.");
                        return;
                    }
