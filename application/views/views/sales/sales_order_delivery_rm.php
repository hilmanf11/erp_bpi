    ...
    <form id="frm_insert" method="post" novalidate>
        ...
        <fieldset style="width:100%; border:1px solid #d0d0d0; margin-bottom: 10px; border-radius:4px; float: left;">
            ...
            <div class="fitem">
                ...
                <input style="width:30%;" name="qty" id="qty" class="easyui-numberbox" data-options="precision: 2">
...
<script>
    ...
    function update() {
        ...
        // if(row.status != 1){
            if (row) {
                ...
                url_save = '<?= base_url('sales/sales_order_delivery_rm/update') ?>?id=' + btoa(row.id);
            } else {
    ...
    $('#filter_customer_order_no').combobox({
        url: '<?= base_url('sales/sales_order_delivery_rm/readCustomerOrders/'); ?>',
        valueField: 'customer_order_no',
        textField: 'customer_order_no',
        prompt: 'Choose All',
        icons: [{
    ...
    $('#filter_sales_order_no').combobox({
        url: '<?= base_url('sales/sales_order_delivery_rm/readSalesOrders/'); ?>',
        valueField: 'sales_order_no',
        textField: 'sales_order_no',
        prompt: 'Choose All',
        icons: [{
    ...
    $('#filter_item_fg').combogrid({
        url: '<?= base_url('sales/sales_order_delivery_rm/readProductNos/'); ?>',
        panelWidth: 400,
        idField: 'id',
        textField: 'number',
        mode: 'remote',
