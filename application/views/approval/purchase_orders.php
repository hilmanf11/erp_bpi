...
<table id="dg" class="easyui-datagrid" style="width:99.5%;" toolbar="#toolbar">
    <thead>
        <tr>
            ...
            <th data-options="field:'item_family_name',width:100">Product <br>Family</th>
            <th data-options="field:'uom',width:60">Uom</th>
            <th data-options="field:'supplier_name',width:200">Supplier Name</th>
            <th data-options="field:'mpq',width:60">MPQ</th>
            <th data-options="field:'moq',width:60">MOQ</th>
            <th data-options="field:'qty',width:60,formatter: numberformat">Qty</th>
            <th data-options="field:'currency',width:60">Currency</th>
            <th data-options="field:'discount',width:60,formatter: numberformat">Discount</th>
            <th data-options="field:'price',width:100,formatter: numberformat">Price</th>
