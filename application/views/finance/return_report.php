...
<script>
    ...
    function filter() {
        ...
        $("#printout").attr('src', '<?= base_url('finance/return_report/print') ?>' + url);
    }
    ...
    function excel() {
        ...
        // Unduh file
        window.location.assign('<?= base_url('finance/return_report/print/excel') ?>' + url);
    ...
    $('#filter_division').combobox({
        url: '<?= base_url('finance/return_report/readsDivision/'); ?>',
        valueField: 'number',
        textField: 'number',
