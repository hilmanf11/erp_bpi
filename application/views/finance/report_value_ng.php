...
<script>
    ...
    function filter() {
        ...
        if (yearFrom !== yearTo) {
            ...
            url = "?filter_from=" + filter_from + "&filter_to=" + filter_to + "&filter_items=" + filter_items + "&filter_display=" + filter_display + "&filter_customer=" + filter_customer + "&filter_division=" + filter_division;
            $("#printout").contents().find('html').html("<center><br><br><br><b style='font-size:20px;'>Please Wait...</b></center>");
            $("#printout").attr('src', '<?= base_url('finance/report_value_ng/print') ?>' + url);
        }
    }
    ...
    function filter_sum_customer() {
        ...
        if (yearFrom !== yearTo) {
            ...
            url = "?filter_from=" + filter_from + "&filter_to=" + filter_to + "&filter_items=" + filter_items + "&filter_display=" + filter_display + "&filter_customer=" + filter_customer + "&filter_division=" + filter_division;
            $("#printout").contents().find('html').html("<center><br><br><br><b style='font-size:20px;'>Please Wait...</b></center>");
            $("#printout").attr('src', '<?= base_url('finance/report_value_ng/print_sum_customer') ?>' + url);
        }
    }
    ...
    function excel() {
        ...
        if (yearFrom !== yearTo) {
            ...
            url = "?filter_from=" + filter_from + "&filter_to=" + filter_to + "&filter_items=" + filter_items + "&filter_display=" + filter_display + "&filter_customer=" + filter_customer + "&filter_division=" + filter_division;
            window.location.assign('<?= base_url('finance/report_value_ng/print/excel') ?>' + url);
        }
    }
    ...
    function excelsumcust() {
        ...
        if (yearFrom !== yearTo) {
            ...
            url = "?filter_from=" + filter_from + "&filter_to=" + filter_to + "&filter_items=" + filter_items + "&filter_display=" + filter_display + "&filter_customer=" + filter_customer + "&filter_division=" + filter_division;
            window.location.assign('<?= base_url('finance/report_value_ng/print_sum_customer/excel') ?>' + url);
        }
    }
    ...
    $('#filter_customer').combobox({
        url: '<?= base_url('finance/report_value_ng/readCust'); ?>',
        valueField: 'id',
        textField: 'name',
