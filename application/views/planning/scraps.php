<table id="dg" class="easyui-datagrid" style="width:99.5%;" toolbar="#toolbar">
    <thead>
        <tr>
            ...
            <th rowspan="2" data-options="field:'wo_no',width:120,halign:'center'">Workorder</th>
            ...
            <th rowspan="2" data-options="field:'material_request',width:120,halign:'center'">Material Request</th>
...
<script>
    ...
    function filter() {
        ...
        url = "?filter_from=" + filter_from + "&filter_to=" + filter_to + "&filter_document=" + filter_document + "&filter_item_id=" + filter_item_id;
        $('#dg').datagrid({
        ...
        $("#filter_document").combobox({
            ...
            onSelect: function(row) {
                $('#filter_item_id').combogrid({
                    url: '<?= base_url('planning/scraps/readItems/') ?>' + window.btoa(row.document),
                    panelWidth: 500,
                    idField: 'item_rm_id',
    ...
    // $('#filter_item_id').combogrid({
    //     url: '<?= base_url('master/item_rm/readItems/') ?>',
    //     panelWidth: 500,
    //     idField: 'item_rm_id',
    //     textField: 'item_rm_number',
    //     mode: 'remote',
    ...
    function statusformat(value, row) {
        ...
        if (row.material_request == null) {

            return "<b style='color:green;'>OPEN</b>";

        } else if (row.material_request != null) {
