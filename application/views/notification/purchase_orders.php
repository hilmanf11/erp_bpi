...
<table id="dg" class="easyui-datagrid" style="width:99.5%;" toolbar="#toolbar">
    <thead>
        <tr>
            ...
            <th data-options="field:'po_name',width:150">PO Name</th>
            <th data-options="field:'delivery_date',width:150">Delivery Date</th>
            <th data-options="field:'supplier_name',width:250">Supplier Name</th>
            ...
            <th data-options="field:'revision',width:80">Rev</th>
...
<script>
    ...
    $(function() {
        ...
        $('#dg').datagrid({
            url: '<?= base_url('notifications/notificationData/purchase_orders/') ?>' + "<?= base64_encode($user) ?>" + "/" + "<?= base64_encode($name) ?>",
            pagination: false,
            singleSelect: false,
            clientPaging: false,
            rownumbers: true,
