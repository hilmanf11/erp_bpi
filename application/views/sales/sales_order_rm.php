            ...
            <fieldset style="width:100%; border:1px solid #d0d0d0; margin-bottom: 10px; margin-top: 10px; border-radius:4px;">
                ...
                <div style="width: 100%; float: left;">
                    ...
                    <div class="fitem">
                        ...
                        <input style="width:60%; text-align:right;" id="total_dpp" name="total_dpp" readonly class="easyui-numberbox" data-options="groupSeparator:','">
                    </div>
                    <div class="fitem">
...
<script>
    ...
    function add() {
        ...
        $('#customer_id').combobox({
            ...
            onSelect: function(customer) {
                ...
                addTable(customer.id, customer_address_id, division);
                    ...
                    onSelect: function(division) {
                        ...
                        addTable(customer_id, customer_address_id, division.number);

                        $('#plant').combogrid({
                            url: '<?= base_url('sales/sales_order_rm/readAddress/'); ?>' + customer.id + "/" + division.number,
                            panelWidth: 400,
                            idField: 'plant',
                            textField: 'plant',
                            mode: 'remote',
                            ...
                            onSelect: function(index, row) {
                                ...
                                addTable(customer.id, row.id, division);
                            }
                        });
                    }
                });
    ...
    function addTable(customer_id="",customer_address_id ="", division="", link = "") {
            ...
            columns: [
                [{
                    ...
                    editor: {
                        type: 'combogrid',
                        options: {
                            url: '<?= base_url('sales/sales_order_rm/readItemFg/'); ?>' + customer_id + "/" + customer_address_id + "/" + division,
                            required: true,
                            panelWidth: 650,
                            idField: 'id',
                            textField: 'id',
    ...
    function update() {
        ...
        if (row) {
            ...
            addTable(row.customer_id,row.customer_address_id,row.division, '<?= base_url('sales/sales_order_rm/datatableUpdates?sales_order_no=') ?>' + window.btoa(row.sales_order_no));
    ...
    $('#filter_sales_order_no').combobox({
        url: '<?= base_url('sales/sales_order_rm/readSalesOrders/'); ?>',
        valueField: 'sales_order_no',
        textField: 'sales_order_no',
        prompt: 'Choose All',
        icons: [{
    ...
    $('#filter_customer_order_no').combobox({
        url: '<?= base_url('sales/sales_order_rm/readCustomerOrders/'); ?>',
        valueField: 'customer_order_no',
        textField: 'customer_order_no',
        prompt: 'Choose All',
        icons: [{
