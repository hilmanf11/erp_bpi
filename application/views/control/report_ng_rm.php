...
<script>
    ...
    function filter() {
        ...
        if (yearFrom !== yearTo) {
            ...
            $("#printout").attr('src', '<?= base_url('control/report_ng_rm/print') ?>' + url);
        }
    }
    ...
    function filter_sum_customer() {
        ...
        if (yearFrom !== yearTo) {
            ...
            url = "?filter_from=" + filter_from + "&filter_to=" + filter_to + "&filter_items=" + filter_items + "&filter_display=" + filter_display + "&filter_item_family=" + filter_item_family + "&filter_division=" + filter_division;
            $("#printout").contents().find('html').html("<center><br><br><br><b style='font-size:20px;'>Please Wait...</b></center>");
            $("#printout").attr('src', '<?= base_url('control/report_ng_rm/print_sum_customer') ?>' + url);
        }
    }
    ...
    function excel() {
        ...
        if (yearFrom !== yearTo) {
            ...
            url = "?filter_from=" + filter_from + "&filter_to=" + filter_to + "&filter_items=" + filter_items + "&filter_display=" + filter_display + "&filter_item_family=" + filter_item_family + "&filter_division=" + filter_division;
            window.location.assign('<?= base_url('control/report_ng_rm/print/excel') ?>' + url);
        }
    }
    ...
    function excelsumcust() {
        ...
        if (yearFrom !== yearTo) {
            ...
            url = "?filter_from=" + filter_from + "&filter_to=" + filter_to + "&filter_items=" + filter_items + "&filter_display=" + filter_display + "&filter_item_family=" + filter_item_family + "&filter_division=" + filter_division;
            window.location.assign('<?= base_url('control/report_ng_rm/print_sum_customer/excel') ?>' + url);
        }
    }
    ...
    $("#filter_item_family").combobox({
        url: '<?= base_url('control/report_ng_rm/readItemFamilys/') ?>',
        valueField: 'id',
        textField: 'name',
