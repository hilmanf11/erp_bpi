        ...
        <div style="width: 49%; float:left;">
            ...
            <div class="fitem" hidden>
                ...
                <select style="width:60%;" id="filter_trans_type" class="easyui-combobox" panelHeight="auto" disabled>
                    ...
                    <option value="SCAN RECEIPT CRUSHER">SCAN RECEIPT CRUSHER</option>
                </select>
            </div>
        </div>
...
<script>
    ...
    function filter() {
        ...
        $("#printout").attr('src', '<?= base_url('warehouse/report_history_transactions_other_component/print') ?>' + url);
    }
    ...
    function excel() {
        ...
        // Unduh file
        window.location.assign('<?= base_url('warehouse/report_history_transactions_other_component/print/excel') ?>' + url);
        ...
        $("#filter_item_category").combobox({
            ...
            onSelect: function(category) {
                $("#filter_item_family").combobox({
                    url: '<?= base_url('warehouse/report_history_transactions_other_component/readItemFamily/') ?>' + category.id,
                    valueField: 'number',
                    textField: 'name',
    ...
    $("#filter_item_family").combobox({
        url: '<?= base_url('warehouse/report_history_transactions_other_component/readItemFamilys/') ?>',
        valueField: 'number',
        textField: 'name',
        prompt: "Select Product Family",
        icons: [{
