...
<table id="dg" class="easyui-datagrid" style="width:100%;" toolbar="#toolbar">
    <thead>
        <tr>
            ...
            <th rowspan="2" data-options="field:'qty_bpm',width:100,halign:'center',align:'right',formatter:numberformat, styler:numberStyle2"> Bpm Qty</th>
...
<div id="toolbar" style="height: 320px;">
    ...
    <div style="width: 100%; padding: 10px;">
        <fieldset style="width: 100%; border:2px solid #d0d0d0; margin-bottom: 5px; margin-top: 5px; border-radius:4px;">
            ...
            <div class="fitem" style="padding:0 200px 0 200px;">
                <input style="width:100%; height: 80px;" type="text" id="request_no" name="request_no" class="scan" placeholder="SCAN BPM NO HERE">
            </div>
            <div class="fitem" style="padding:0 200px 0 200px;">
    ...
    $(function() {
        ...
        $('#request_no').keypress(function(e) {
            if (e.which == 13) {
                ...
                Swal.fire({
                    title: 'Please Wait Checking BPM',
                ...
                $.ajax({
                    type: "GET",
                    url: "<?= base_url('warehouse/scan_item_bpm/getDeliveryOrders') ?>",
        ...
        $('#label').keypress(function(e) {
            if (e.which == 13) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('warehouse/scan_item_bpm/getChecksheetLabel') ?>",
                    ...
                    success: function(json) {
                        ...
                        if (json.total > 0) {
                            ...
                            for (let i = 0; i < json.total; i++) {
                                $.ajax({
                                    type: "POST",
                                    url: "<?= base_url('warehouse/scan_item_bpm/create') ?>",
                                    data: {
                                        label: label,
