    ...
    <fieldset style="width: 100%; border:2px solid #d0d0d0; margin-bottom: 5px; margin-top: 5px; border-radius:4px;">
        ...
        <div style="width: 50%; float:left;">
            ...
            <div class="fitem">
                ...
                <a href="javascript:;" class="easyui-linkbutton" onclick="filter_recap_cust()"><i class="fa fa-search"></i> Recap Customer</a>
            </div>
        </div>
...
<script>
    ...
    function filter_recap_cust() {
        ...
        url = "?filter_from=" + filter_from + "&filter_to=" + filter_to + "&filter_items=" + filter_items + "&filter_display=" + filter_display + "&filter_trans_type=" + filter_trans_type + "&filter_division=" + filter_division;
        $("#printout").contents().find('html').html("<center><br><br><br><b style='font-size:20px;'>Please Wait...</b></center>");
        $("#printout").attr('src', '<?= base_url('warehouse/report_history_transaction_boxs/recap_customer') ?>' + url);
    }
    ...
    function excel() {
        ...
        // Unduh file
        window.location.assign('<?= base_url('warehouse/report_history_transaction_boxs/print/excel') ?>' + url);
    ...
    function filter_recap_cust_excel() {
        ...
        window.location.assign('<?= base_url('warehouse/report_history_transaction_boxs/recap_customer/excel') ?>' + url);
    ...
    $('#filter_items').combogrid({
        url: '<?= base_url('warehouse/report_history_transaction_boxs/readItemBox/') ?>',
        panelWidth: 600,
        idField: 'id',
        textField: 'name',
        mode: 'remote',
