...
<script>
    ...
    //     url_save = '<?= base_url('warehouse/warehouse_transferred/create') ?>';
    ...
    //     $.ajax({
    //         type: "post",
    //         url: "<?= base_url('warehouse/warehouse_transferred/autonumber') ?>",
    //         dataType: "html",
    ...
    //                     type: 'combogrid',
    //                     options: {
    //                         url: '<?= base_url('warehouse/warehouse_transferred/readItemFg/'); ?>',
    //                         required: true,
    //                         panelWidth: 400,
    //                         idField: 'item_fg_id',
    ...
    //                     type: 'combogrid',
    //                     options: {
    //                         url: '<?= base_url('warehouse/warehouse_transferred/readMachine/'); ?>',
    //                         required: true,
    //                         panelWidth: 200,
    //                         idField: 'number',
    ...
    //                 url: '<?= base_url('warehouse/warehouse_transferred/readItemFg/'); ?>' + period,
    //                 panelWidth: 700,
    //                 idField: 'item_fg_id',
    //                 textField: 'Product ID',
    //                 mode: 'remote',
    ...
    //     $.ajax({
    //         method: 'post',
    //         url: '<?= base_url('warehouse/warehouse_transferred/delete') ?>',
    //         data: {
    //             id: id,
    //         },
    //         success: function(result) {
    ...
    //         addTable('<?= base_url('warehouse/warehouse_transferred/datatableUpdates?number=') ?>' + window.btoa(row.number));
    //     } else {
                ...
                handler: function() {
                    ...
                    for (let i = 0; i < totalrows; i++) {
                        if (rows[i].item_fg_id) {
                            ...
                            var url_save = "<?= base_url('warehouse/warehouse_transferred/create') ?>";
