...
<table id="dg" class="easyui-datagrid" style="width:100%;" toolbar="#toolbar">
    <thead>
        <tr>
            ...
            <th rowspan="2" data-options="field:'maker',width:120,halign:'center'">Maker</th>
            <th rowspan="2" data-options="field:'item_supplier',width:120,halign:'center'">Supplier Product</th>
            <th rowspan="2" data-options="field:'item_family_name',width:150,halign:'center'">Product Family</th>
            <th rowspan="2" data-options="field:'mpq',width:80,halign:'center'">MPQ</th>
            <th rowspan="2" data-options="field:'moq',width:100,halign:'center'">MOQ</th>
            <th rowspan="2" data-options="field:'share_order',width:100,halign:'center'">Share Order %</th>
            <th rowspan="2" data-options="field:'leadtime',width:100,halign:'center'">Leadtime</th>
            <th rowspan="2" data-options="field:'price',width:120,halign:'center',align:'right',formatter:priceformat">Price</th>
            <th rowspan="2" data-options="field:'valid_date',width:100,halign:'center'">Valid Date</th>
            <th rowspan="2" data-options="field:'safety_stock',width:100,halign:'center'">Safet Stock %</th>
            <th rowspan="2" data-options="field:'uom_default',width:100,halign:'center'">Uom <br>Default</th>
            <th rowspan="2" data-options="field:'uom_inventory',width:100,halign:'center'">Uom <br>Inventory</th>
        ...
        <fieldset style="width:100%; border:1px solid #d0d0d0; margin-bottom: 10px; border-radius:4px; float: left;">
            ...
            <div style="float:left; width:50%;">
                ...
                <div class="fitem">
                    ...
                    <input style="width:60%;" name="item_supplier" id="item_supplier" class="easyui-textbox">
                </div>
                <div class="fitem">
                ...
                <div class="fitem">
                    <span style="width:35%; display:inline-block;">Share Order</span>
                    <input style="width:60%;" name="share_order" id="share_order" class="easyui-numberbox">
                </div>
                <div class="fitem">
            ...
            <div style="float:left; width:50%;">
                <div class="fitem">
                    ...
                    <input style="width:60%;" name="price" id="price" class="easyui-textbox">
                </div>
                <div class="fitem">
                    <span style="width:35%; display:inline-block;">Valid Date</span>
                    <input style="width:60%;" name="valid_date" id="valid_date" required="" data-options="formatter:myformatter,parser:myparser,editable:false" class="easyui-datebox">
                </div>
                <div class="fitem">
                    <span style="width:35%; display:inline-block;">Safety Stock</span>
                    <input style="width:60%;" name="safety_stock" id="safety_stock" class="easyui-numberbox">
                </div>
                <div class="fitem">
