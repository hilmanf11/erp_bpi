    ...
    <fieldset style="width: 100%; border:2px solid #d0d0d0; margin-bottom: 5px; margin-top: 5px; border-radius:4px;">
        ...
        <div style="width: 50%; float:left;">
            <div class="fitem">
                ...
                <input style="width:60%;" name="filter_machine_id" id="filter_machine_id" class="easyui-combobox">
            </div>
            <div class="fitem">
                <span style="width:35%; display:inline-block;">Toonage</span>
                <input style="width:60%;" name="filter_toonage" id="filter_toonage" class="easyui-numberbox">
            </div>
            <div class="fitem">
...
<script>
    ...
    function filter() {
        ...
        var filter_toonage = $("#filter_toonage").numberbox('getValue');

        url = "?&filter_items=" + filter_items + "&filter_division=" + filter_division + "&filter_status=" + filter_status + "&filter_machine_id=" + filter_machine_id + "&filter_toonage=" + filter_toonage;
        $("#printout").contents().find('html').html("<center><br><br><br><b style='font-size:20px;'>Please Wait...</b></center>");
        $("#printout").attr('src', '<?= base_url('master/report_menu_loadings/print') ?>' + url);
    }
    ...
    function excel() {
        ...
        // Unduh file
        window.location.assign('<?= base_url('master/report_menu_loadings/print/excel') ?>' + url);
