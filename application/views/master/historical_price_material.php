...
<script>
    ...
    function filter() {
        ...
        url = "?filter_from=" + filter_from + "&filter_to=" + filter_to + "&filter_item_category=" + filter_item_category + "&filter_item_family=" + filter_item_family + "&filter_items=" + filter_items + "&filter_division=" + filter_division;
        $("#printout").contents().find('html').html("<center><br><br><br><b style='font-size:20px;'>Please Wait...</b></center>");
        $("#printout").attr('src', '<?= base_url('master/historical_price_material/print') ?>' + url);
    }
    ...
    function excel() {
        ...
        // Unduh file
        window.location.assign('<?= base_url('master/historical_price_material/print/excel') ?>' + url);
        ...
        $("#filter_item_category").combobox({
            ...
            onSelect: function(category) {
                $("#filter_item_family").combobox({
                    url: '<?= base_url('master/historical_price_material/readItemFamily/') ?>' + category.id,
                    valueField: 'number',
                    textField: 'name',
    ...
    $("#filter_item_family").combobox({
        url: '<?= base_url('master/historical_price_material/readItemFamilys/') ?>',
        valueField: 'number',
        textField: 'name',
        prompt: "Select Product Family",
        icons: [{
