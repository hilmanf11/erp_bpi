...
<div id="dlg_insert" class="easyui-dialog" title="Add New" data-options="closed: true,modal:true" style="width: 400px; padding:10px; top: 20px;">
    <form id="frm_insert" method="post" novalidate>
        <fieldset style="width:100%; border:1px solid #d0d0d0; margin-bottom: 10px; border-radius:4px; float: left;">
            ...
            <div class="fitem">
                <span style="width:35%; display:inline-block;">Minimum Stock(Day)</span>
                <input style="width:60%;" name="mins" id="mins" required="" class="easyui-numberbox">
            </div>
            <div class="fitem">
                <span style="width:35%; display:inline-block;">Maximum Stock(Day)</span>
                <input style="width:60%;" name="maks" id="maks" required="" class="easyui-numberbox">
            </div>
            <div class="fitem">
                <span style="width:35%; display:inline-block;">Leadtime Pickup(Day)</span>
                <input style="width:60%;" name="leadtime" id="leadtime" required="" class="easyui-numberbox">
            </div>
        </fieldset>
    </form>
</div>
