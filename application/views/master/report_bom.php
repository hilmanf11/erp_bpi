...
<script>
    ...
    function filter() {
        ...
        url = "?&filter_items=" + filter_items + "&filter_division=" + filter_division + "&filter_status=" + filter_status  + "&filter_item_rm_id=" + filter_item_rm_id;
        $("#printout").contents().find('html').html("<center><br><br><br><b style='font-size:20px;'>Please Wait...</b></center>");
        $("#printout").attr('src', '<?= base_url('master/report_bom/print') ?>' + url);
    }
    ...
    function excel() {
        ...
        // Unduh file
        window.location.assign('<?= base_url('master/report_bom/print/excel') ?>' + url);
