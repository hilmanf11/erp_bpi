...
<table id="dg" class="easyui-datagrid" style="width:99.5%;" toolbar="#toolbar">
    <thead>
        <tr>
            ...
            <th rowspan="2" data-options="field:'name',width:200,halign:'center'">Department Name</th>
...
<script>
    ...
    function update() {
        ...
        if (row) {
            ...
            url_save = '<?= base_url('master/departments/update') ?>?id=' + btoa(row.id);
        } else {
    ...
    //PRINT EXCEL
    function excel() {
        window.location.assign('<?= base_url('master/departments/print/excel') ?>');
    }
    //RELOAD
    function reload() {
    ...
    $(function() {
        ...
        $('#dg').datagrid({
            url: '<?= base_url('master/departments/datatables') ?>',
            pagination: true,
            clientPaging: false,
            remoteFilter: true,
            rownumbers: true,
