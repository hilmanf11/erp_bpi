...
class Departments extends CI_Controller
{
    public function __construct()
    {
        ...
        //VALIDASI FORM
        $this->form_validation->set_rules('name', 'Name', 'required|min_length[1]|max_length[100]|is_unique[departments.name]');
    }
    //HALAMAN UTAMA
    ...
    public function update()
    {
        if ($this->input->post()) {
            ...
            $post = $this->input->post();
            $send = $this->crud->update('departments', ["id" => $id], $post);
            echo $send;
        } else {
            show_error("Cannot Process your request");
        }
    ...
    public function delete()
    {
        ...
        $send = $this->crud->delete('departments', $data);
        echo $send;
    }
    //PRINT & EXCEL DATA
