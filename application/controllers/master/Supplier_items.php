...
class Supplier_items extends CI_Controller
{
    ...
    public function readSuppliers()
    {
        ...
        $this->db->select('b.*, c.number as item_number, a.mpq, a.moq, a.price, a.share_order, a.uom_default, a.item_supplier, a.remark, c.item_category_id');
        $this->db->from('supplier_items a');
        $this->db->join('suppliers b', 'a.supplier_id = b.id');
        $this->db->join('item_rm c', 'a.item_rm_id = c.id');
    ...
    public function print($option = "")
    {
        ...
        foreach ($records as $data) {
            $html .= '<tr>
                    ...
                    <td style="mso-number-format:\@;">' . str_replace("Ø", "&Oslash;", $data['item_rm_number']) . '</td>
