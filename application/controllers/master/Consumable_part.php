...
class Consumable_part extends CI_Controller
{
    ...
    public function index()
    {
        if (empty($this->session->username)) {
            ...
            $this->load->view('master/consumable_part');
        } else {
    ...
    public function reads()
    {
        ...
        $send = $this->crud->reads('consumable_part', ["item_fg_id" => $post]);
   ...
   public function readRunner()
    ...
    public function delete()
    {
        if ($this->input->method() === 'post') 
        {
            ...
            if ($item_fg_id !== null) {
                ...
                $result = $this->crud->delete('consumable_part', $dataFinal);
                echo json_encode($result);
    ...
    {
        @unlink('failed/consumable_part.txt');
    }
    ...
    public function uploadcreateFailed()
    {
        if ($this->input->post()) {
            ...
            $textFailed = fopen('failed/consumable_part.txt', 'a');
    ...
    {
        $file = "failed/consumable_part.txt";
    ...
    public function print($option = "")
    {
        if ($option == "excel") {
            ...
            header("Content-Disposition: attachment; filename=consumable_part_$format.xls");
        }
        ...
        <table id="consumable_part" border="1">
            <tr>
                <th width="20">No</th>
                <th>Product ID</th>
                <th>Product No</th>
