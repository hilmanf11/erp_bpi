...
class Employees extends CI_Controller
{
    ...
    public function index()
    {
        if (empty($this->session->username)) {
            ...
            $this->load->view('master/employees');
        } else {
    ...
    public function reads()
    {
        ...
        $send = $this->crud->reads('employees', ["nik" => $post]);
    ...
    public function uploadcreate()
    {
        if ($this->input->post()) {
            ...
            // $machine = $this->crud->read('employees', [], ["id" => $data['machine_id']]);
            ...
            // } else {
                ...
                $send   = $this->crud->create('employees', $dataFinal);
                echo $send;
            // }
        }
    }
