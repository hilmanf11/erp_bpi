    ...
    public function getDataMrp()
    {
        if ($this->input->get()) {
            ...
            foreach ($generates as $generate) {
                ...
                $balance_1 = ($stock - $qty_wip - $os_wo - $qty_supply);
            ...
            <body>
                ...
                <table id="customers" border="1">
                    <tr>
                        ...
                        <th colspan="4" style="text-align:center;">STOCK OF RAW MATERIAL</th>
                    ...
                    <tr>
                        ...
                        <th style="text-align:center;">OS PO</th>
                    ...
                    foreach ($records as $record) {
                        ...
                        $html .= "  <tr>
                                        ...
                                        <td style='text-align:right;'>".round($record['qty_rm'] + $record['qty_wip'] + $record['os_po'])."</td>
