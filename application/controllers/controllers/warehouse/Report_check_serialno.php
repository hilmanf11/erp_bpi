...
class Report_check_serialno extends CI_Controller
{
    ...
    public function print($option = "")
    {
        ...
        //Details
        $this->db->select('a.*, b.number as item_number, b.name as item_name, c.label_no, c.status as status_label,
        IF(d.label_no IS NOT NULL, 1, 0) as issued_label,  c.qty');
        ...
        foreach ($records as $data) {
            ...
            if ($data['issued_label'] == 0) {
                $issued_status = "<b style='color:green;'>OPEN</b>";
            } else {
                $issued_status = "<b style='color:red;'>CLOSE</b>";
            }
            $html .= '  <tr>
