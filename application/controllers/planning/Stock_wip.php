    ...
    public function uploadcreate()
    {
        if ($this->input->post()) {
            ...
            if (empty($item_fg->id)) {
                ...
                $send = $this->crud->update('stock_wip', ["document_no" => $data['document_no'],"item_fg_id" => $data['item_fg_id'],"revision" => $data['revision'],"p_month" => $data['p_month'],"p_year" => $data['p_year']], $data);
                echo $send;
            } else {
