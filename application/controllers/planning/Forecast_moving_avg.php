...
class Forecast_moving_avg extends CI_Controller
{
    ...
    public function index()
    {
        if (empty($this->session->username)) {
            ...
            $this->load->view('planning/forecast_moving_avg');
        } else {
    ...
    public function print($option = "")
    {
        if ($option == "excel") {
            ...
            header("Content-Disposition: attachment; filename=forecast_moving_avg_$format.xls");
        }
        ...
        if ($filter_customer_name == "" && $filter_item_fg == ""){
            $html = '<html><head><title>Print Data</title></head><style>body {font-family: Arial, Helvetica, sans-serif;}#forecast_moving_avg {border-collapse: collapse;width: 100%;font-size: 12px;}#forecast_moving_avg td, #forecast_moving_avg th {border: 1px solid #ddd;padding: 2px;}#forecast_moving_avg tr:nth-child(even){background-color: #f2f2f2;}#forecast_moving_avg tr:hover {background-color: #ddd;}#forecast_moving_avg th {padding-top: 2px;padding-bottom: 2px;text-align: left;color: black;}</style><body>
            <center>
            ...
            <br><br>
            <table id="forecast_moving_avg" border="1">
            <tr>
                <th width="20">No</th>
                <th>Product No.</th>
                <th>Product Name</th>
